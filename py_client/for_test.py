...
def UpdateSearch():
	if E_name_search.get()!="" or E_mid_name_search.get()!="" or E_last_name_search.get()!="" or E_contact_search.get()!="" or E_note_search.get()!="":
	
		messagebox.showinfo("Confermation", "Find the information")
	else:
		messagebox.showerror("Error", "Please fill the information")
...
E_mid_name = Entry(Inside_Frame1,width=30, textvariable=E_name_var)
...
E_note = Entry(Inside_Frame1,width=30,textvariable=E_contact_var)
...
Frame1 = LabelFrame(window,text="Enter the Contact Detail for search")
Frame1.grid(padx=5,pady=5)


Inside_Frame2 = Frame(Frame1)
Inside_Frame2.grid(row=3,column=3,padx=15,pady=15)
#---------------------------------------------
l_name_search = Label(Inside_Frame2,text="Name")
l_name_search.grid(row=0,column=0,padx=5,pady=5)
E_name_search_var = StringVar()

E_name_search = Entry(Inside_Frame2,width=30, textvariable=E_name_search_var)
E_name_search.grid(row=0,column=1,padx=5,pady=5)
#---------------------------------------------
l_mid_name_search = Label(Inside_Frame2,text="MidName")
l_mid_name_search.grid(row=1,column=0,padx=5,pady=5)
E_mid_name_search_var = StringVar()

E_mid_name_search = Entry(Inside_Frame2,width=30, textvariable=E_mid_name_search_var)
E_mid_name_search.grid(row=1,column=1,padx=5,pady=5)
#-----------------------------------------------
l_last_name_search= Label(Inside_Frame2,text="LastName")
l_last_name_search.grid(row=2,column=0,padx=5,pady=5)
E_last_name_search_var= StringVar()
E_last_name_search = Entry(Inside_Frame2,width=30,textvariable=E_last_name_search_var)
E_last_name_search.grid(row=2,column=1,padx=5,pady=5)
#---------------------------------------------------
l_contact_search= Label(Inside_Frame2,text="phone")
l_contact_search.grid(row=3,column=0,padx=5,pady=5)
E_contact_search_var = StringVar()
E_contact_search = Entry(Inside_Frame2,width=30,textvariable=E_contact_search_var)
E_contact_search.grid(row=3,column=1,padx=5,pady=5)
#---------------------------------------------------
l_note_search= Label(Inside_Frame2,text="Note")
l_note_search.grid(row=4,column=0,padx=5,pady=5)
E_note_search_var = StringVar()
E_note_search = Entry(Inside_Frame2,width=30,textvariable=E_note_search_var)
E_note_search.grid(row=4,column=1,padx=5,pady=5)
#---------------------------------------------------

Frame3 = Frame(window)
Frame3.grid(row=2,column=1,padx=15,pady=15,sticky=E)
#<><><><><><><><><><><><><><<><<<><><<<><><><><><><><><><>
Search_button = Button(Frame3,text="Search",width=15,bg="#6B69D6",fg="#FFFFFF",command=UpdateSearch)
Search_button.grid(row=0,column=0,padx=8,pady=8)

Reset_search_button = Button(Frame3,text="Reset",width=15,bg="#6B69D6",fg="#FFFFFF",command=EntryReset)
Reset_search_button.grid(row=1,column=0,padx=8,pady=8)
